...
test_that("Test on invalid inputs", {
  ...
  expect_error(PDBCleanup::alignDomainsRigid(NA, NA, NA))
  expect_error(PDBCleanup::alignDomainsRigid(predicted6ofs, NA, domains6ofs))
  expect_error(PDBCleanup::alignDomainsRigid(NA, experimental6ofs, domains6ofs))
  expect_error(PDBCleanup::alignDomainsRigid(predicted6ofs, experimental6ofs, NA))
})
...
test_that("Reduced RMSD after alignment", {
  ...
  predictedAligned <- PDBCleanup::alignDomainsRigid(experimental6ofs, predicted6ofs,
                                               domains6ofs)
